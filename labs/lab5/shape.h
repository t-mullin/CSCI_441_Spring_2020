...
public:
    ...
    Cone(unsigned int n, float r, float g, float b) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            // add triangle viL, viH, vip1L
            add_vertex(coords, vi_x, vi_y, -h, r, g, b, normal.at(0), normal.at(1), normal.at(2));
            add_vertex(coords, c_x, c_y, h, r, g, b, normal.at(0), normal.at(1), normal.at(2));
            add_vertex(coords, vip1_x, vip1_y, -h, r, g, b, normal.at(0), normal.at(1), normal.at(2));
