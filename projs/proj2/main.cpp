...
std::vector<Triangle> wall_plane(glm::vec3 position, float scaler) {
    return Obj::make_box(position, scaler, rand_color());
}
...
int main(int argc, char** argv) {
    ...
    PointLight l1(glm::vec3(1, 1, 1), glm::vec3(4, 10, 0), 1.0, .7, 0.18);
    PointLight l2(glm::vec3(1, 1, 1), glm::vec3(-1, 5, 0), 1.0, .7, 0.18);
    DirectionalLight l3(glm::vec3(.5, .5, .5), glm::vec3(0, -4, 0));
    ...
    //world.append(wall_plane(glm::vec3(10,3,0), 10));
